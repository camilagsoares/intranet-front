...
const ModalCriarCargo = ({ isOpen, onClose }) => {
    ...
    const { data, loadingSecretaria } = useApiRequestGet('/cargo/listar-cargo')


    const handleCriarCargo = (data) => {
        setLoading(true);
        axiosApi
            .post('/cargo/criar-cargo', data)
            .then(() => {
    ...
    /*
{
    ...
    return (
        ...
        >
            <Box sx={style}>
                <Box component='form' noValidate onSubmit={handleSubmit(handleCriarCargo)}>
                       <Typography
                        sx={{
                            fontSize: {
                                lg: 18,
...
export default ModalCriarCargo